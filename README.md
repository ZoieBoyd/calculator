...
I chose to create a replica of iOS' calculator interface due to its simplicity and sleek aesthetic, making it an excellent reference point. 

The primary goal for the completion of this project is to showcase and strengthen my web development skills, particularly in JavaScript.

## Assignment Instructions
[Instructions provided by The Odin Project](https://www.theodinproject.com/lessons/foundations-calculator)
